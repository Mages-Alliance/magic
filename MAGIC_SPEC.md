...
| **Wizard's Notes** | Local Configuration  | The sections within the Spellbook where the Wizard can add personal annotations and instructions.           |
...
*   **`system/` directory:** Contains the foundational components of the Magic framework.
    *   `spellbook.md`: The central **Spellbook**. This is the Wizard's primary guide, containing rituals and space for personal annotations ("Wizard's Notes"). The Spirit is made aware of its contents for contextual understanding.
...
| **The Law of the Unwavering Mirror** | The principle requiring the Spirit to act as an intellectual partner, challenging assumptions and improving the Wizard's reasoning.                                           |
